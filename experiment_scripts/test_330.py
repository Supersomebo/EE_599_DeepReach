...
p.add_argument('--velocity', type=float, default=3, required=False, help='Speed of the dubins car')
...
# dataset = dataio.ReachabilityQuadrupedSource(numpoints=65000, collisionR=opt.collisionR, velocity=opt.velocity,
#                                              omega_max=opt.omega_max, pretrain=opt.pretrain, tMin=opt.tMin,
#                                              tMax=opt.tMax, counter_start=opt.counter_start, counter_end=opt.counter_end,
#                                              pretrain_iters=opt.pretrain_iters, seed=opt.seed,
#                                              num_src_samples=opt.num_src_samples)
...
# loss_fn = loss_functions.initialize_hji_quadruped(dataset, opt.minWith)
